...
function ContactUs() {
  return (
    ...
    >
      <Container>
        <div className="hidden grid-cols-1 sm:grid-cols-3 gap-5 pt-5">
          ...
          <div className="hidden text-white border border-[#557078] rounded-lg hover:shadow-custom-blue duration-300 p-3 sm:p-5 backdrop-blur-sm hover:scale-105">
            <span className="flex justify-center items-center flex-col">
