    ...
    <Container className="">
      <div className="flex flex-col gap-y-5">
        ...
        <div className="text-white font-text">
          <p>
            This Privacy Policy (&quote;Policy&quote;) applies to{" "}
            <Link
              className="font-medium text-primary underline"
              to={"https://shadapixel.com"}
            >
              https://shadapixel.com
            </Link>
            , and Shada Pixel - by Atrion BD (&quote;Company&quote;) and governs
            ...
            The Company&apos;s website is a Digital Agency site. By using the
            Company website, you consent to the data practices described in this
            statement.
          </p>
        </div>
        ...
        <div className="text-white font-text">
          ...
          <p className="text-white font-text mt-2">
        ...
        <div className="text-white font-text">
          ...
          <p className="text-white font-text mt-2">
            ...
            maintain the confidentiality of your information. The Company may
          ...
          <p className="font-text text-white mt-2">
            The Company may automatically collect information about your
            computer hardware and software. This information can include your IP
            ...
            statistics regarding the use of the Company&apos;s website.
          </p>
        </div>
        <div className="text-white font-text">
          <h2 className="mb-2  font-semibold text-2xl">
        ...
        <div className="text-white font-text">
          <h2 className="mb-2  font-semibold text-2xl">Right to Deletion</h2>
          <p className="mt-2">
        ...
        <div className="text-white font-text">
          ...
          <ul className="list-disc pl-5 mt-2">
            <li>
              ...
              good or service requested by you, or reasonably anticipated within
        ...
        <div className="text-white font-text">
          <h2 className="mb-2  font-semibold text-2xl">Email Communications</h2>
          <p>
        ...
        <div className="text-white font-text">
          ...
          <p>
            ...
            Shada Pixel - by Atrion BD, and/or by updating any privacy
        ...
        <div className="text-white font-text mb-24">
          <h2 className="mb-2  font-semibold text-2xl">Contact Information</h2>
          <p>
          ...
          <div className="mt-5">
            ...
            <Link
              className="font-medium text-primary underline"
              to={"tel:+1 (850) 988-0052"}
            >
              +1 (850) 988-0052
            </Link>
          </div>
          <p className="mt-5">Effective as of September 15, 2024</p>
        </div>
      </div>
    </Container>
  );
